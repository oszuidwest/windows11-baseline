...
|---------|-------|--------|
| `DenyDeviceClasses` | `{d48179be-ec20-11d1-b6b8-00c04fa372a7}` | Blocks IEEE 1394 / FireWire devices, matching the Microsoft BitLocker baseline device-install restriction |
