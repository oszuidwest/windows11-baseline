...
**Note:** On Windows 11 24H2, the traditional "Turn off the Store application" GPO is [no longer honored](https://learn.microsoft.com/en-us/answers/questions/5563743/windows-11-24h2-cannot-block-microsoft-store-ignor). This baseline uses AppLocker (`policies/applocker/block-apps.xml`) to block the Store app, Copilot, and `StoreInstaller.exe` from `get.microsoft.com`.
